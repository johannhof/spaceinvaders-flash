package 
{
	...
	public class Level_4 extends Level
	{
		...
		{			var invaders:Array = new Array();
			...
			var test4:BigInvader_I = new BigInvader_I();
			var test4column = 2;
			var test4row = 2;
			test4.x = test4column * 50 + 80;
			test4.y = test4row * 50 + 110;
			invaders[test4column][test4row] = test4;

			var test5:BigInvader_I = new BigInvader_I();
			var test5column = 3;
			var test5row = 2;
			test5.x = test5column * 50 + 90;
			test5.y = test5row * 50 + 110;
